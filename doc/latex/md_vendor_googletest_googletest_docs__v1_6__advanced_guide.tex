...
{\itshape Congratulations! You\textquotesingle{}ve now learned more advanced Google Test tools and are ready to tackle more complex testing tasks. If you want to dive even deeper, you can read the \hyperlink{_v1__6___f_a_q_8md}{Frequently-\/\+Asked Questions}. }