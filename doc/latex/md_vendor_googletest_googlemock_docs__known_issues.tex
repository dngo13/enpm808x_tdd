As any non-\/trivial software system, Google \hyperlink{class_mock}{Mock} has some known limitations and problems. We are working on improving it, and welcome your help! The follow is a list of issues we know about.
...
The {\ttfamily R\+E\+A\+D\+ME} file in release 1.\+1.\+0 still says that Google \hyperlink{class_mock}{Mock} only works with Google Test. Actually, you can configure Google \hyperlink{class_mock}{Mock} to work with any testing framework you choose.

\subsection*{Tests failing on machines using Power PC C\+P\+Us (e.\+g. some Macs)}

{\ttfamily \hyperlink{namespacegmock__output__test}{gmock\+\_\+output\+\_\+test}} and {\ttfamily gmock-\/printers\+\_\+test} are known to fail with Power PC C\+P\+Us. This is due to portability issues with these tests, and is not an indication of problems in Google \hyperlink{class_mock}{Mock} itself. You can safely ignore them.
